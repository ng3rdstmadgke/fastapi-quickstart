...
Revision ID: fdc01b73bde9
Revises: fbb3c327123d
Create Date: 2022-03-06 16:18:02.827741
...
revision = 'fdc01b73bde9'
down_revision = 'fbb3c327123d'
branch_labels = None
depends_on = None
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('items', sa.Column('title', mysql.VARCHAR(length=255), nullable=True))
